...
def run_uat_test(ps_api=None):  # ps_api not used anymore
    log_msgs = []
    def log(msg):
        log_msgs.append(msg)
        print(msg)

    # Replace with actual values from your login
   ...
   def place_order(trantype, tsym, qty, prctyp, prc, remarks):
    ...
    # ⚠️ Modify and cancel require similar POST API calls (not shown here)
